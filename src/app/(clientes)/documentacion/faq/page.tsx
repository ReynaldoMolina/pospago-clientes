...
export const metadata = {
  title: "Documentación - Preguntas frecuentes",
};

export default async function Page() {
  return (
    <>
      <AppHeader title="Preguntas frecuentes" />
      <PageWrapper>
        <div className="w-full max-w-3xl mx-auto">
          ...
          <TypographyP>
            Es cuando el cliente paga entre el 15 y 18 de cada mes. Se le dan 4
            GB de YouTube gratis, no importa el plan que tenga.
          </TypographyP>

          <TypographyH3>Planes pospago disponibles</TypographyH3>
          ...
          <TypographyH3>Tipos de clientes</TypographyH3>
          ...
          <table className="w-full my-6">
            <thead>
              <TableTr>
                <TableTh className="w-20">Fecha</TableTh>
                <TableTh>Descripción</TableTh>
            ...
            <tbody>
              ...
              <TableTr>
                <TableTd>11</TableTd>
                <TableTd>Inicio del ciclo (acreditación).</TableTd>
              ...
              <TableTr>
                <TableTd>25</TableTd>
                <TableTd>Desactivo temporal.</TableTd>
                <TableTd></TableTd>
              </TableTr>
              <TableTr>
                <TableTd>4</TableTd>
